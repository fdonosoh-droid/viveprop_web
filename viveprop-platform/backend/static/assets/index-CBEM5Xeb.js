(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const a of s)if(a.type==="childList")for(const i of a.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&n(i)}).observe(document,{childList:!0,subtree:!0});function o(s){const a={};return s.integrity&&(a.integrity=s.integrity),s.referrerPolicy&&(a.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?a.credentials="include":s.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function n(s){if(s.ep)return;s.ep=!0;const a=o(s);fetch(s.href,a)}})();const $={UF:39908,STOCK:[],PROJECTS:[],CC_DATA:{},_GC:{}},xt=24,re="/api";async function mt(t){const e=await fetch(re+t);if(!e.ok)throw new Error(`API ${t}: ${e.status}`);return e.json()}const gt={stock:()=>mt("/stock"),projects:()=>mt("/projects"),cc:()=>mt("/cc"),uf:()=>mt("/uf"),geocodes:()=>mt("/geocodes"),priGeo:()=>mt("/pri-geocodes"),reloadData:()=>fetch(re+"/data/reload",{method:"POST"}).then(t=>t.json())},Lt={sec:new Set,pri:new Set};let de=[],pe=[];function ue(t,e){t==="sec"?de=e:pe=e}function me(t){return Lt[t]}function ge(t){const e=(document.getElementById(t+"-mc-input").value||"").toLowerCase(),o=t==="sec"?de:pe,n=Lt[t],s=document.getElementById(t+"-mc-dropdown"),a=o.filter(i=>(!e||i.toLowerCase().includes(e))&&!n.has(i));if(!a.length){s.style.display="none";return}s.innerHTML=a.slice(0,14).map(i=>`<div class="mc-opt" onmousedown="mcSelect('${t}','${i.replace(/'/g,"\\'")}');return false">${i}</div>`).join(""),s.style.display="block"}function Ze(t){ge(t)}function Ye(t){setTimeout(()=>{const e=document.getElementById(t+"-mc-dropdown");e&&(e.style.display="none")},150)}function Qe(t,e){Lt[t].add(e),ve(t),document.getElementById(t+"-mc-input").value="",document.getElementById(t+"-mc-dropdown").style.display="none",t==="sec"?window.secFilter():window.priFilter()}function Xe(t,e){Lt[t].delete(e),ve(t),t==="sec"?window.secFilter():window.priFilter()}function ve(t){document.getElementById(t+"-mc-tags").innerHTML=[...Lt[t]].map(e=>`<span class="mc-tag">${e} <span onclick="mcRemove('${t}','${e.replace(/'/g,"\\'")}')">×</span></span>`).join("")}const r=t=>String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;");function w(t){if(!t)return null;const e=parseFloat(String(t).replace(/\./g,"").replace(",","."));return isNaN(e)?null:e}const d={uf:t=>`UF ${(+t).toLocaleString("es-CL",{minimumFractionDigits:0,maximumFractionDigits:0})}`,uf1:t=>`UF ${(+t).toLocaleString("es-CL",{minimumFractionDigits:1,maximumFractionDigits:1})}`,uf2:t=>`UF ${(+t).toLocaleString("es-CL",{minimumFractionDigits:2,maximumFractionDigits:2})}`,pesos:t=>`$${Math.round(+t).toLocaleString("es-CL")}`};function fe(t){const e=(t||"").toLowerCase();return e.includes("lista para arrendar")?"Disponible":e.includes("re-acondicionamiento")?"Reacondicionando":e.includes("por desocuparse")?"Por desocuparse":e.includes("aviso")?"Aviso salida":e.includes("check-in")?"Prox. check-in":e.includes("arrendado")?"Arrendado":t||"—"}function to(t){const e=(t||"").toLowerCase();return e.includes("lista para arrendar")?"background:#D1FAE5;color:#065F46":e.includes("desocuparse")?"background:#DBEAFE;color:#1D4ED8":e.includes("re-acondicionamiento")||e.includes("reacondicionando")?"background:#FEF3C7;color:#92400E":e.includes("aviso")?"background:#FEE2E2;color:#991B1B":e.includes("check-in")||e.includes("esperando")?"background:#EDE9FE;color:#5B21B6":e.includes("arrendado")?"background:#F1F5F9;color:#475569":"background:#F3F4F6;color:#374151"}function eo(t){var s,a;const e=(t||"").toLowerCase(),o=parseInt((s=e.match(/(\d+)d/))==null?void 0:s[1])||0,n=parseInt((a=e.match(/(\d+)b/))==null?void 0:a[1])||(e.includes("estudio")?1:0);return{dorm:o,banos:n}}function dt(t){return/estac|bode|parking|reja|local\s/i.test(t||"")}function oo(t,e){const o=(t||"").toLowerCase();return e==="lista"?o.includes("lista para arrendar"):e==="desocupar"?o.includes("desocuparse"):e==="reacond"?o.includes("re-acondicionamiento")||o.includes("reacondicionando"):e==="aviso"?o.includes("aviso"):e==="proximo"?o.includes("check-in")||o.includes("esperando"):e==="arrendado"?o.includes("arrendado"):!1}const no={"Lista para arrendar":"#10B981","Por desocuparse":"#2563EB","Re-acondicionamiento":"#D97706","Aviso salida":"#DC2626","Esperando check-in":"#7C3AED",Arrendado:"#94A3B8"};let vt=null,_t=null,ft=null,At=null,tt=null,wt=null;function Jt(t){const e=`${t.direccion}|${t.comuna}`;if($._GC[e]!==void 0)return $._GC[e];try{const o=JSON.parse(localStorage.getItem("_geo_cache")||"{}");if(o[e]!==void 0)return o[e]}catch{}}function so(t){const e=`<svg xmlns="http://www.w3.org/2000/svg" width="28" height="36" viewBox="0 0 28 36">
    <path d="M14 0C6.27 0 0 6.27 0 14c0 9.75 14 22 14 22S28 23.75 28 14C28 6.27 21.73 0 14 0z" fill="${t}"/>
    <circle cx="14" cy="14" r="6" fill="white"/></svg>`;return L.divIcon({html:e,className:"",iconSize:[28,36],iconAnchor:[14,36],popupAnchor:[0,-36]})}function he(t){if(!t)return"";const e=t.replace(/^https?:\/\//,"");return`https://images.weserv.nl/?url=${encodeURIComponent(e)}&output=jpg&q=88`}function io(t,e){const o=e.replace(/^https?:\/\//,"");return`https://images.weserv.nl/?url=${encodeURIComponent(o)}&output=jpg&q=80&w=540&h=296&fit=cover`}function ao(){vt||(vt=L.map("sec-map",{zoomControl:!0}).setView([-33.45,-70.65],11),L.tileLayer("https://{s}.basemaps.cartocdn.com/light_all/{z}/{x}/{y}{r}.png",{attribution:"© OpenStreetMap © CARTO",maxZoom:19}).addTo(vt),_t=L.markerClusterGroup({maxClusterRadius:50,showCoverageOnHover:!1}),vt.addLayer(_t))}function co(){return vt}function be(t){if(!vt)return;_t.clearLayers();const e=[];t.forEach(o=>{const n=Jt(o);n?$e(o,n):n===void 0&&e.push(o)}),e.length&&ro(e)}let ye="lista";function lo(t){ye=t}function $e(t,e){const o=w(t.precioSinBono),n=w(t.m2total)||w(t.m2interior),s=no[t.estado]||"#94A3B8",a=fe(t.estado),i=`<div class="map-popup">
  ...
  </div>`,c=L.marker(e,{icon:so(s)});c.bindPopup(i,{className:"lf-popup",maxWidth:270,closeButton:!1}),c.on("popupopen",()=>{document.getElementById("mpp-"+t.id)&&fetch(`https://api.assetplan.cl/api/v1/property/for_sale/${t.id}?list=1`).then(v=>v.json()).then(v=>{var m,P;const u=(m=v.data)==null?void 0:m[0],h=((P=u==null?void 0:u.fotos_originales)!=null&&P.length?u.fotos_originales:u==null?void 0:u.fotos)||[];if(h.length){const y=document.getElementById("mpp-"+t.id);if(y){const g=io(t.id,h[0]);y.style.backgroundImage=`url('${g}')`,y.textContent=""}}}).catch(()=>{})}),_t.addLayer(c)}async function ro(t){const e=document.getElementById("geo-progress"),o=document.getElementById("geo-bar"),n=document.getElementById("geo-msg");e.style.display="flex";let s={};try{s=JSON.parse(localStorage.getItem("_geo_cache")||"{}")}catch{}for(let a=0;a<t.length&&ye==="mapa";a++){const i=t[a],c=`${i.direccion}|${i.comuna}`;n.textContent=`Ubicando ${a+1} de ${t.length}`,o.style.width=`${Math.round((a+1)/t.length*100)}%`;const p=encodeURIComponent(`${i.direccion}, ${i.comuna}, Santiago, Chile`);try{const u=await(await fetch(`https://nominatim.openstreetmap.org/search?q=${p}&format=json&limit=1`,{headers:{"Accept-Language":"es"}})).json();if(u[0]){const h=[parseFloat(u[0].lat),parseFloat(u[0].lon)];s[c]=h,$._GC[c]=h,$e(i,h)}else s[c]=null}catch{s[c]=null}try{localStorage.setItem("_geo_cache",JSON.stringify(s))}catch{}await new Promise(v=>setTimeout(v,1200))}e.style.display="none"}function po(){ft||(ft=L.map("pri-map",{zoomControl:!0}).setView([-33.45,-70.65],11),L.tileLayer("https://{s}.basemaps.cartocdn.com/light_all/{z}/{x}/{y}{r}.png",{attribution:"© OpenStreetMap © CARTO",maxZoom:19}).addTo(ft),At=L.markerClusterGroup({maxClusterRadius:50,showCoverageOnHover:!1}),ft.addLayer(At))}function uo(){return ft}let Ce="lista";function mo(t){Ce=t}function Fe(t){if(!ft)return;At.clearLayers();const e=[];t.forEach(o=>{const n=Jt({direccion:o.direccion,comuna:o.comuna});n?Pe(o,n):n===void 0&&e.push(o)}),e.length&&go(e)}function Pe(t,e){const{isExtra:o}=window._mapUtils||{},n=(t.unidades||[]).filter(m=>m.disponible&&!/estac|bode|parking|reja|local\s/i.test(m.tipologia||"")),s=n.map(m=>m.precio_uf).filter(m=>m>0),a=s.length?Math.min(...s):0,i=s.length?Math.max(...s):0,c=[...new Set(n.map(m=>{const P=parseInt(m.dormitorios)||0;return P===0?"Estudio":P+"D"}))].sort().slice(0,3).join(", "),p=t.foto_portada||"",v=L.divIcon({className:"",html:'<div style="width:13px;height:13px;background:#F4545A;border:3px solid #fff;border-radius:50%;box-shadow:0 2px 6px rgba(0,0,0,.35)"></div>',iconSize:[13,13],iconAnchor:[6,6]}),u=L.marker(e,{icon:v}),h=`<div class="map-popup">
  ...
  </div>`;u.bindPopup(h,{className:"lf-popup",maxWidth:270,closeButton:!1}),At.addLayer(u)}async function go(t){const e=document.getElementById("pri-geo-progress"),o=document.getElementById("pri-geo-bar"),n=document.getElementById("pri-geo-msg");e.style.display="flex";let s={};try{s=JSON.parse(localStorage.getItem("_geo_cache")||"{}")}catch{}for(let a=0;a<t.length&&Ce==="mapa";a++){const i=t[a],c=`${i.direccion}|${i.comuna}`;n.textContent=`Ubicando ${a+1} de ${t.length}`,o.style.width=`${Math.round((a+1)/t.length*100)}%`;const p=encodeURIComponent(`${i.direccion||i.nombre}, ${i.comuna||""}, Chile`);try{const u=await(await fetch(`https://nominatim.openstreetmap.org/search?q=${p}&format=json&limit=1`,{headers:{"Accept-Language":"es"}})).json();if(u[0]){const h=[parseFloat(u[0].lat),parseFloat(u[0].lon)];s[c]=h,$._GC[c]=h,Pe(i,h)}else s[c]=null}catch{s[c]=null}try{localStorage.setItem("_geo_cache",JSON.stringify(s))}catch{}await new Promise(v=>setTimeout(v,1200))}e.style.display="none"}function vo(t){if(!t)return;tt?tt.invalidateSize():(tt=L.map("pm-map",{zoomControl:!0}).setView([-33.45,-70.65],14),L.tileLayer("https://{s}.basemaps.cartocdn.com/light_all/{z}/{x}/{y}{r}.png",{attribution:"© OpenStreetMap © CARTO",maxZoom:19}).addTo(tt)),wt&&(tt.removeLayer(wt),wt=null);const e=Jt({direccion:t.direccion,comuna:t.comuna});e?Ee(t,e):fo(t),setTimeout(()=>{tt&&tt.invalidateSize()},200)}function Ee(t,e){const o=L.divIcon({className:"",html:'<div style="width:14px;height:14px;background:var(--coral);border:3px solid #fff;border-radius:50%;box-shadow:0 2px 6px rgba(0,0,0,.35)"></div>',iconSize:[14,14],iconAnchor:[7,7]});wt=L.marker(e,{icon:o}).addTo(tt),wt.bindPopup(`<b>${r(t.nombre)}</b><br>${r(t.direccion||"")}${t.comuna?", "+r(t.comuna):""}`).openPopup(),tt.setView(e,15)}async function fo(t){const e=encodeURIComponent(`${t.direccion||t.nombre}, ${t.comuna||""}, Chile`);try{const n=await(await fetch(`https://nominatim.openstreetmap.org/search?q=${e}&format=json&limit=1`,{headers:{"Accept-Language":"es"}})).json();if(n[0]){const s=[parseFloat(n[0].lat),parseFloat(n[0].lon)];let a={};try{a=JSON.parse(localStorage.getItem("_geo_cache")||"{}")}catch{}a[`${t.direccion}|${t.comuna}`]=s;try{localStorage.setItem("_geo_cache",JSON.stringify(a))}catch{}$._GC[`${t.direccion}|${t.comuna}`]=s,Ee(t,s)}}catch{}}let ht=[],Z=1,xe="lista",Ot={},Pt=null,G=[],Y=0,q=null,K=null,Ht="";function ho(){if(!$.STOCK.length){document.getElementById("sec-grid").innerHTML='<div class="empty-g"><div class="eg-ico">⚠️</div><p>No se pudo cargar el stock. Verificar backend.</p></div>';return}const t=[...new Set($.STOCK.map(e=>e.comuna).filter(Boolean))].sort();ue("sec",t),document.getElementById("sec-mc-input").addEventListener("blur",()=>window.mcClose("sec")),Tt()}function Tt(){var P,y,g,C,F,I;if(!$.STOCK.length)return;const t=(((P=document.getElementById("sec-search"))==null?void 0:P.value)||"").toLowerCase(),e=me("sec"),o=parseFloat((y=document.getElementById("sec-precio-min"))==null?void 0:y.value)||0,n=parseFloat((g=document.getElementById("sec-precio-max"))==null?void 0:g.value)||0,s=((C=document.getElementById("sec-op"))==null?void 0:C.checked)||!1,a=((F=document.getElementById("sec-est"))==null?void 0:F.checked)||!1,i=((I=document.getElementById("sec-bod"))==null?void 0:I.checked)||!1,c=[...document.querySelectorAll('[data-grp="sec-dorm"].active')].map(l=>parseInt(l.dataset.val)),p=[...document.querySelectorAll('[data-grp="sec-bano"].active')].map(l=>parseInt(l.dataset.val)),v=[...document.querySelectorAll(".sec-estado-cb")],u=v.filter(l=>l.checked).map(l=>l.value),h=u.length===v.length,m=window._secMaxUF||null;ht=$.STOCK.filter(l=>{if(t&&!`${l.condominio||""} ${l.direccion||""} ${l.comuna||""}`.toLowerCase().includes(t)||e.size&&!e.has(l.comuna)||s&&!l.oportunidad||a&&(!l.est||l.est==="0")||i&&(!l.bod||l.bod==="0")||!h&&!u.some(S=>oo(l.estado,S)))return!1;const{dorm:b,banos:D}=eo(l.tipologia);if(c.length&&!c.some(S=>S===4?b>=4:b===S)||p.length&&!p.some(S=>S===3?D>=3:D===S))return!1;const E=parseFloat((l.precioSinBono||"0").replace(/\./g,"").replace(",","."));return!(o&&E<o||n&&E>n||m&&E>m)}),Z=1,xe==="mapa"?be(ht):we()}function we(){const t=document.getElementById("sec-grid"),e=ht.length,o=Math.max(1,Math.ceil(e/xt));Z>o&&(Z=o),document.getElementById("sec-count").textContent=`${e.toLocaleString("es-CL")} propiedad${e!==1?"es":""}`,document.getElementById("sec-pager").textContent=`Pág. ${Z} / ${o}`,document.getElementById("sec-prev").disabled=Z<=1,document.getElementById("sec-next").disabled=Z>=o;const n=$.STOCK.length,s=$.STOCK.filter(c=>(c.estado||"").toLowerCase().includes("lista para arrendar")).length,a=document.getElementById("tb-stats");a&&(a.textContent=`${s.toLocaleString("es-CL")} disponibles · ${n.toLocaleString("es-CL")} total`);const i=ht.slice((Z-1)*xt,Z*xt);if(!i.length){t.innerHTML='<div class="empty-g"><div class="eg-ico">🔍</div><p>Sin propiedades para los filtros seleccionados</p></div>';return}t.innerHTML=i.map(c=>{const p=parseFloat((c.precioSinBono||"0").replace(/\./g,"").replace(",",".")),v=c.bonoPct>0,u=c.m2interior||c.m2total||"—",h=c.orientacion&&c.orientacion!=="-"?c.orientacion:"—",m=fe(c.estado),P=to(c.estado);return`<div class="prop-card">
    ...
    </div>`}).join(""),Pt&&Pt.disconnect(),Pt=new IntersectionObserver(c=>{c.forEach(p=>{if(!p.isIntersecting)return;const v=p.target.id.replace("pcimg-","");bo(v),Pt.unobserve(p.target)})},{rootMargin:"150px"}),i.forEach(c=>{const p=document.getElementById("pcimg-"+c.id);p&&Pt.observe(p)})}async function bo(t){var o,n;const e=document.getElementById("pcimg-"+t);if(e){if(Ot[t]){ie(e,Ot[t]);return}try{const a=(o=(await(await fetch(`https://api.assetplan.cl/api/v1/property/for_sale/${t}?list=1`)).json()).data)==null?void 0:o[0],i=((n=a==null?void 0:a.fotos_originales)!=null&&n.length?a.fotos_originales:a==null?void 0:a.fotos)||[];if(i.length){Ot[t]=i[0];const c=document.getElementById("pcimg-"+t);c&&ie(c,i[0],i.length)}}catch{}}}function ie(t,e,o){const n=e.replace(/^https?:\/\//,""),s=`https://images.weserv.nl/?url=${encodeURIComponent(n)}&output=jpg&q=75&w=400&h=200&fit=cover`;t.style.backgroundImage=`url('${s}')`,t.style.backgroundSize="cover",t.style.backgroundPosition="center";const a=t.querySelector(".pc-img-icon");if(a&&(a.style.display="none"),o>1){const i=t.id.match(/pcimg-(.+)/);if(i){const c=document.getElementById("pcfc-"+i[1]);c&&(c.textContent="📷 "+o,c.style.display="")}}}function yo(t){const e=Math.max(1,Math.ceil(ht.length/xt));Z=Math.min(Math.max(1,Z+t),e),we(),document.getElementById("mod-sec").querySelector(".gondola-wrap").scrollTop=0}function $o(t){xe=t,lo(t),document.getElementById("btn-lista").classList.toggle("active",t==="lista"),document.getElementById("btn-mapa").classList.toggle("active",t==="mapa");const e=document.getElementById("sec-gondola-wrap"),o=document.getElementById("sec-map-wrap"),n=document.querySelector("#mod-sec .pager");e.style.display=t==="lista"?"":"none",o.style.display=t==="mapa"?"flex":"none",n&&(n.style.display=t==="lista"?"flex":"none"),t==="mapa"&&(ao(),setTimeout(()=>co().invalidateSize(),120),be(ht))}async function Ie(t){var n,s,a;if(q=$.STOCK.find(i=>i.id===t)||null,!q)return;document.getElementById("detail-modal").classList.add("open"),document.body.style.overflow="hidden",G=[],Y=0,(n=document.getElementById("dp-nophoto"))==null||n.remove(),document.getElementById("dp-img").style.display="none",document.getElementById("dp-spin").style.display="flex",document.getElementById("dp-counter").style.display="none",document.getElementById("dp-thumbs").innerHTML="",document.getElementById("dp-prev").disabled=!0,document.getElementById("dp-next").disabled=!0,document.getElementById("detail-content").innerHTML='<div style="color:var(--g500);text-align:center;padding:30px">Cargando información…</div>';const e=q;try{K=((s=(await(await fetch(`https://api.assetplan.cl/api/v1/property/for_sale/${e.id}?list=1`)).json()).data)==null?void 0:s[0])||null}catch{K=null}const o=((a=K==null?void 0:K.fotos_originales)!=null&&a.length?K.fotos_originales:K==null?void 0:K.fotos)||[];if(o.length)G=o,document.getElementById("dp-spin").style.display="none",Kt(0),document.getElementById("dp-thumbs").innerHTML=o.map((i,c)=>{const p=i.replace(/^https?:\/\//,"");return`<img src="https://images.weserv.nl/?url=${encodeURIComponent(p)}&output=jpg&q=70&w=120" onclick="showDpPhoto(${c})" ${c===0?'class="active"':""}>`}).join("");else{document.getElementById("dp-spin").style.display="none";const i=document.querySelector(".detail-photos"),c=document.createElement("div");c.id="dp-nophoto",c.style.cssText="color:rgba(255,255,255,.4);font-size:14px;position:absolute;inset:0;display:flex;align-items:center;justify-content:center;pointer-events:none",c.textContent="Sin fotos disponibles",i.appendChild(c)}Fo(e,K)}function Co(t){Ie(t)}function Kt(t){var n;Y=Math.max(0,Math.min(t,G.length-1));const e=document.getElementById("dp-img"),o=G[Y].replace(/^https?:\/\//,"");e.src=`https://images.weserv.nl/?url=${encodeURIComponent(o)}&output=jpg&q=88&w=900`,e.style.display="block",document.getElementById("dp-counter").style.display="block",document.getElementById("dp-counter").textContent=`${Y+1} / ${G.length}`,document.getElementById("dp-prev").disabled=Y===0,document.getElementById("dp-next").disabled=Y===G.length-1,document.querySelectorAll(".dp-thumbs img").forEach((s,a)=>s.classList.toggle("active",a===Y)),(n=document.getElementById("dp-thumbs").children[Y])==null||n.scrollIntoView({inline:"nearest",block:"nearest"})}function Gt(t){Kt(Y+t)}function Fo(t,e){var g;const o=w(t.precioSinBono),n=w(t.m2total)||w(e==null?void 0:e.superficie),s=w(t.m2interior)||w(e==null?void 0:e.m2_utiles),a=w(t.m2terraza)||w(e==null?void 0:e.m2_terraza),i=(e==null?void 0:e.dormitorios)??"",c=(e==null?void 0:e.banios)??"",p=(e==null?void 0:e.piso)??"",v=((g=e==null?void 0:e.unitggcc)==null?void 0:g.monto)||(e==null?void 0:e.ggcc)||"",u=(e==null?void 0:e.youtube_video_id)||"",h=(e==null?void 0:e.espacios)||"",m=(e==null?void 0:e.building_finishes)||[],P=(t.oportunidad||"").toLowerCase().includes("oportunidad"),y=h?h.split(",").map(C=>C.trim()).filter(Boolean):[];document.getElementById("detail-content").innerHTML=`
    ...
    <div class="dt-finishes">${m.map(C=>{var b;const F=String(C).split(":"),I=((b=F[0])==null?void 0:b.trim())||"",l=F.slice(1).join(":").trim()||"";return`<div class="dt-finish-row"><div class="dt-finish-k">${r(I)}</div><div class="dt-finish-v">${r(l)}</div></div>`}).join("")}</div>`:""}
    ${u?`
    ...
    ${n}
  </div>`}function Wt(){var t;document.getElementById("detail-modal").classList.remove("open"),document.body.style.overflow="",G=[],Y=0,q=null,K=null,(t=document.getElementById("dp-nophoto"))==null||t.remove()}function Eo(t){const e=q;if(!e)return;const o=w(e.precioSinBono),n=w(e.m2total)||w(e.m2interior),s=[`🏢 *${e.condominio||e.direccion}*`,`📍 ${e.direccion}${e.dp?" · DP "+e.dp:""} · ${e.comuna}`,`📐 ${n?n.toFixed(0)+" m²":""} · ${e.tipologia||""}`,e.est&&e.est!=="0"?"🚗 Estacionamiento incluido":"",e.bod&&e.bod!=="0"?"📦 Bodega incluida":"",o?`💰 ${o.toLocaleString("es-CL",{maximumFractionDigits:0})} UF`:"",e.bonoPct>0?`✅ Acepta Bono Pie ${e.bonoPct}%`:"",e.video?`
...
`),a=`https://wa.me/?text=${encodeURIComponent(s)}`,i=document.createElement("div");i.style.cssText="position:fixed;inset:0;background:rgba(0,0,0,.5);z-index:700;display:flex;align-items:center;justify-content:center;padding:20px",i.innerHTML=`<div style="background:#fff;border-radius:16px;padding:24px;max-width:480px;width:100%;box-shadow:0 24px 60px rgba(0,0,0,.2)">
    ...
    <div style="display:flex;gap:8px;margin-top:12px">
  ...
  </div>`,document.body.appendChild(i),i.addEventListener("click",c=>{c.target===i&&i.remove()})}async function xo(){if(!G.length)return;const t=document.getElementById("btn-dl-fotos"),e=document.getElementById("loading-overlay"),o=document.getElementById("loading-msg"),n=document.getElementById("loading-bar");t.classList.add("loading"),t.textContent="⏳ Descargando…",e.classList.add("show"),n.style.width="0%";const s=new JSZip,a=s.folder("fotos-propiedad"),i=G.length;async function c(h){try{const m=await fetch(he(h));if(m.ok)return await m.blob()}catch{}try{const m=await fetch(h,{mode:"cors"});if(m.ok)return await m.blob()}catch{}return null}let p=0;for(let h=0;h<i;h++){o.textContent=`Descargando foto ${h+1} de ${i}…`,n.style.width=`${Math.round(h/i*90)}%`;const m=await c(G[h]);if(m){const P=m.type.includes("png")?"png":"jpg";a.file(`foto-${String(h+1).padStart(2,"0")}.${P}`,m),p++}}o.textContent="Generando ZIP…",n.style.width="95%";const v=await s.generateAsync({type:"blob"});if(n.style.width="100%",p===0){alert("No se pudieron descargar las fotos."),e.classList.remove("show"),t.classList.remove("loading"),t.textContent=`📥 Descargar Fotos (${G.length})`;return}const u=document.createElement("a");u.href=URL.createObjectURL(v),u.download=`fotos-${((q==null?void 0:q.condominio)||(q==null?void 0:q.direccion)||"propiedad").replace(/[^a-zA-Z0-9]/g,"-")}.zip`,u.click(),setTimeout(()=>{e.classList.remove("show"),t.classList.remove("loading"),t.textContent=`📥 Descargar Fotos (${G.length})`},800)}async function wo(){var Ft;if(!q)return;const t=q,e=K,o=document.querySelector(".btn-ficha"),n=o.textContent;o.textContent="⏳ Generando PDF…",o.disabled=!0;const s=w(t.precioSinBono),a=w(t.m2total)||w(e==null?void 0:e.superficie),i=w(t.m2interior)||w(e==null?void 0:e.m2_utiles),c=w(t.m2terraza)||w(e==null?void 0:e.m2_terraza),p=(e==null?void 0:e.dormitorios)??"",v=(e==null?void 0:e.banios)??"",u=(e==null?void 0:e.piso)??"",h=((Ft=e==null?void 0:e.unitggcc)==null?void 0:Ft.monto)||(e==null?void 0:e.ggcc)||"";((e==null?void 0:e.espacios)||"").split(",").map(M=>M.trim()).filter(Boolean),e!=null&&e.building_finishes;const m=(t.condominio||t.direccion||"propiedad").replace(/[^a-zA-Z0-9]/g,"-"),P=new Date().toLocaleDateString("es-CL",{day:"2-digit",month:"long",year:"numeric"});async function y(M){for(const A of[he(M),M])try{const k=await fetch(A);if(!k.ok)continue;const R=await k.blob();return await new Promise(j=>{const O=new FileReader;O.onload=X=>j(X.target.result),O.readAsDataURL(R)})}catch{}return null}o.textContent="⏳ Cargando logo…";const g=await y("images/logo.png");o.textContent="⏳ Cargando fotos…";const F=(await Promise.all(G.slice(0,5).map(y))).filter(Boolean);if(o.textContent="⏳ Generando PDF…",!window.jspdf){alert("jsPDF no disponible."),o.textContent=n,o.disabled=!1;return}const{jsPDF:I}=window.jspdf,l=new I({unit:"mm",format:"a4",orientation:"portrait"}),b=210,D=297,E=10,S=190,x=[67,56,202],f=[107,114,128],T=[249,250,251],B=[255,255,255],J=[17,24,39],W=[5,150,105],Bt=[209,250,229],ot=M=>l.setFillColor(M[0],M[1],M[2]),z=M=>l.setTextColor(M[0],M[1],M[2]),pt=(M,A,k,R,j,O)=>{ot(O),l.roundedRect(M,A,k,R,j,j,"F")},Ut=(M,A)=>(ot([229,231,235]),l.rect(E,A,S,.3,"F"),l.setFontSize(7.5),l.setFont("helvetica","bold"),z(f),l.text(M.toUpperCase(),E,A+4.5),A+8);let U=0;ot(x),l.rect(0,0,b,22,"F"),g?(pt(E-1,3,44,15,2.5,B),l.addImage(g,"PNG",E+1,5,40,7.4,void 0,"FAST")):(l.setFont("helvetica","bold"),l.setFontSize(16),z(B),l.text("ViveProp",E,14)),l.setFont("helvetica","normal"),l.setFontSize(8.5),z([200,200,230]),l.text("Ficha de Propiedad",b-E,10,{align:"right"}),l.text(P,b-E,16,{align:"right"}),U=22,ot([238,242,255]),l.rect(0,U,b,32,"F"),l.setFont("helvetica","bold"),l.setFontSize(15),z(J);const st=t.condominio||t.direccion||"—";l.text(st.length>38?st.slice(0,36)+"…":st,E,U+11),l.setFont("helvetica","normal"),l.setFontSize(9),z(f);const $t=`${t.direccion||"—"} · ${t.comuna||""}${t.dp?" · DP "+t.dp:""}`;if(l.text($t.length>55?$t.slice(0,53)+"…":$t,E,U+18),l.setFont("helvetica","bold"),l.setFontSize(20),z(x),l.text(s?s.toLocaleString("es-CL",{maximumFractionDigits:0})+" UF":"—",b-E,U+13,{align:"right"}),l.setFontSize(8),z(f),l.setFont("helvetica","normal"),l.text("Precio sin bono pie",b-E,U+8,{align:"right"}),t.bonoPct>0&&(pt(b-E-42,U+18,42,9,2,Bt),l.setFont("helvetica","bold"),l.setFontSize(8),z(W),l.text(`Acepta Bono Pie ${t.bonoPct}%`,b-E-21,U+23.5,{align:"center"})),U+=34,F.length){const R=F.length>1?118:S,j=S-R-2;try{l.addImage(F[0],"JPEG",E,U,R,52,void 0,"FAST")}catch{}if(F[1])try{l.addImage(F[1],"JPEG",E+R+2,U,j,25,void 0,"FAST")}catch{}if(F[2])try{l.addImage(F[2],"JPEG",E+R+2,U+25+2,j,25,void 0,"FAST")}catch{}if(U+=54,F[3]||F[4]){const O=F[4]?(S-2)/2:S;if(F[3])try{l.addImage(F[3],"JPEG",E,U,O,32,void 0,"FAST")}catch{}if(F[4])try{l.addImage(F[4],"JPEG",E+O+2,U,O,32,void 0,"FAST")}catch{}U+=34}}U+=4,U=Ut("Características",U);const ut=[t.tipologia?{v:t.tipologia,l:"Tipología"}:null,a?{v:a.toFixed(0)+" m²",l:"Superficie"}:null,i?{v:i.toFixed(0)+" m²",l:"Sup. interior"}:null,c?{v:c.toFixed(0)+" m²",l:"Terraza"}:null,p!==""?{v:p+" dorm.",l:"Dormitorios"}:null,v!==""?{v:v+" baños",l:"Baños"}:null,u!==""?{v:"Piso "+u,l:"Nivel"}:null,t.orientacion&&t.orientacion!=="-"?{v:t.orientacion,l:"Orientación"}:null,t.est&&t.est!=="0"?{v:"Incluido",l:"Estacionamiento"}:null,t.bod&&t.bod!=="0"?{v:"Incluida",l:"Bodega"}:null,t.anio?{v:t.anio,l:"Año"}:null,h?{v:"$"+Number(h).toLocaleString("es-CL"),l:"GC/mes"}:null].filter(Boolean),it=4,at=(S-(it-1)*3)/it,Ct=14;ut.forEach((M,A)=>{const k=A%it,R=Math.floor(A/it),j=E+k*(at+3),O=U+R*(Ct+3);pt(j,O,at,Ct,2,T),l.setFont("helvetica","bold"),l.setFontSize(9),z(J),l.text(String(M.v).slice(0,18),j+at/2,O+6.5,{align:"center"}),l.setFont("helvetica","normal"),l.setFontSize(7),z(f),l.text(M.l,j+at/2,O+11,{align:"center"})}),U+=Math.ceil(ut.length/it)*(Ct+3)+4,ot(x),l.rect(0,D-16,b,16,"F"),g?(pt(E-1,D-14,33,11,2,B),l.addImage(g,"PNG",E+1,D-12.5,29,5.4,void 0,"FAST")):(l.setFont("helvetica","bold"),l.setFontSize(11),z(B),l.text("ViveProp",E,D-7)),l.setFont("helvetica","normal"),l.setFontSize(8),z([200,200,230]),l.text("www.viveprop.cl · Stock de propiedades en gestión",b-E,D-7,{align:"right"}),l.save(`ficha-${m}.pdf`),o.textContent=n,o.disabled=!1}function Io(t){Ht=t;const e=document.getElementById("video-player-wrap"),o=t.match(/(?:youtu\.be\/|youtube\.com\/(?:watch\?v=|shorts\/|embed\/))([A-Za-z0-9_-]{11})/);o?(e.style.paddingTop="56.25%",e.innerHTML=`<iframe src="https://www.youtube-nocookie.com/embed/${o[1]}?autoplay=1&rel=0&playsinline=1"
      allow="accelerometer;autoplay;clipboard-write;encrypted-media;gyroscope;picture-in-picture;web-share"
      ...
      src="${r(t)}">Tu navegador no soporta reproducción de video.</video>`),document.getElementById("video-copy-btn").textContent="🔗 Copiar enlace para cliente",document.getElementById("video-modal").style.display="flex",document.body.style.overflow="hidden"}function Lo(){const t=document.getElementById("video-copy-btn");navigator.clipboard.writeText(Ht).then(()=>{t.textContent="✅ Enlace copiado",setTimeout(()=>{t.textContent="🔗 Copiar enlace para cliente"},2500)}).catch(()=>{prompt("Copia este enlace:",Ht)})}function Le(){document.getElementById("video-modal").style.display="none",document.getElementById("video-player-wrap").innerHTML="",document.body.style.overflow=""}function V(t){if(!t)return 0;const e=String(t).match(/(\d+(?:[.,]\d+)?)/);return e?parseFloat(e[1].replace(",","."))/100:0}function Vt(t){if(!t)return 0;const e=parseFloat(String(t).replace(/\./g,"").replace(",","."));return isFinite(e)&&e>=1e3?Math.round(e):0}function Bo(t){if(!t)return 0;const e=String(t).match(/(\d+(?:[.,]\d+)?)/);return e?parseFloat(e[1].replace(",",".")):0}function Et(t){if(!t)return 0;const e=String(t).match(/(\d+)/);return e?parseInt(e[1]):0}function Uo(t){const e={};for(const[o,n]of(t==null?void 0:t.campos)||[])o&&(e[String(o).trim()]=String(n??"").trim());return e}function Mo(t,e){const o=Uo(t),n=(e||"").toUpperCase(),s={descuentoDepto:0,descuentoAdicional:0,aporteInmobiliario:0,reservaCLP:1e5,reservaUF:0,cuotasPieN:1,upfrontPct:0,piePctDefault:null,pieConstPct:0,creditoDirectoPct:0,cuotonPct:0,tipoEntrega:"Futura",nota:(t==null?void 0:t.nota)||""};if(n.includes("INGEVEC")){const a=Et(o["Cuotas pie"]);return{...s,descuentoDepto:V(o["Dcto. depto."]),aporteInmobiliario:V(o["Aporte inmobiliario"]),reservaCLP:Vt(o.Reserva),cuotasPieN:Math.max(a-1,0),pieConstPct:V(o["Pie período const."]),creditoDirectoPct:V(o["Pie crédito s/int."]),cuotonPct:V(o.Cuotón),tipoEntrega:o["Tipo de entrega"]||"Futura",nota:(t==null?void 0:t.nota)||""}}if(n.includes("MAESTRA")){const a=V(o.Upfront),i=V(o["Pie en cuotas"]);return{...s,descuentoDepto:V(o["Descuento Base"])+V(o["Dcto Adicional"]),aporteInmobiliario:V(o["Certificado Pago"]),upfrontPct:a,piePctDefault:a+i||null,cuotasPieN:Et(o["UPAGO Cuotas"]),tipoEntrega:o.ENTREGA?String(o.ENTREGA).trim():"Futura",nota:(t==null?void 0:t.nota)||""}}if(n.includes("RVC")){const a=V(o["Pie mínimo"]);return{...s,descuentoDepto:V(o["Descuento RVC"]),piePctDefault:a||null,cuotasPieN:Et(o["Cuotas prog."]),tipoEntrega:o["Tipo entrega"]||o.Financiamiento||"Futura",nota:(t==null?void 0:t.nota)||""}}if(n.includes("TOCTOC")||n.includes("TOC TOC")){const a=o["Monto Reserva"]||"",i=/uf/i.test(a),c=V(o["Pie minimo %"]);return{...s,descuentoDepto:V(o["Descuento autorizado"]),reservaCLP:i?0:Vt(a),reservaUF:i?Bo(a):0,piePctDefault:c||null,cuotasPieN:Et(o.Cuotas),tipoEntrega:o.Estado||"Futura",nota:(t==null?void 0:t.nota)||""}}if(n.includes("URMENETA")){const a=(t==null?void 0:t.nota)||"",i=a.match(/(\d+(?:[.,]\d+)?)\s*%\s*bono\s+pie/i)||a.match(/bono\s+pie\s+(\d+(?:[.,]\d+)?)\s*%/i)||a.match(/(\d+(?:[.,]\d+)?)\s*%\s+\d+D\b/i),c=i?parseFloat(i[1].replace(",","."))/100:0;return{...s,descuentoDepto:V(o["Descuento máximo"]),aporteInmobiliario:c,reservaCLP:Vt(o["Valor reserva"]),pieConstPct:V(o["% cuotas const."]),cuotasPieN:Et(o["N° cuotas const."]),tipoEntrega:o["Tipo de entrega"]||"Futura",nota:a}}return s}const St={MESES_ARRIENDO_ANIO:11,HAIRCUT_VENTA:.95,PLUSVALIA_DEFAULT:.02},ae={MAESTRA:{tipoCalculoBono:"maestra",ltvMaxPct:.8,pieConjuntosPct:.2},INGEVEC:{tipoCalculoBono:"precio-lista-depto",ltvMaxPct:1,pieConjuntosPct:.2},URMENETA:{tipoCalculoBono:"precio-lista-total",ltvMaxPct:1,pieConjuntosPct:.2},RVC:{tipoCalculoBono:"precio-lista-depto",ltvMaxPct:1,pieConjuntosPct:.2},TOCTOC:{tipoCalculoBono:"precio-lista-depto",ltvMaxPct:1,pieConjuntosPct:.2},DEFAULT:{tipoCalculoBono:"precio-lista-depto",ltvMaxPct:1,pieConjuntosPct:.2}},So=[.04,.045,.05],Be=30,Ue=.12;function To(t,e,o){return t===0?o/e:o*t/(1-Math.pow(1+t,-e))}function Do(t){const e=(t||"").toUpperCase();return ae[e]||ae.DEFAULT}function _o(t){const{precioListaDepto:e,descuentoPct:o,bonoPiePct:n,reservaCLP:s,preciosConjuntos:a,piePct:i,upfrontPct:c,plazoAnios:p,tasasCAE:v,valorUF:u,cuotonPct:h,piePeriodoConstruccionPct:m,pieCreditoDirectoPct:P,cuotasPieN:y,arriendosMensualesCLP:g,plusvaliaAnual:C,tipoCalculoBono:F}=t,I=t.pieConjuntosPct??.2,l=(a||[]).reduce((ct,zt)=>ct+zt,0),b=e+l,D=Math.min(o+0,1),E=e*(1-D),S=l,x=E+S,f=x*u,T=F==="maestra"?i:I,B=Math.round(E*i*100)/100,J=Math.round(l*T*100)/100,W=B+J,Bt=s/u,ot=Math.round(x*(c||0)*100)/100,z=W-Bt-ot,pt=z*u,Ut=y>0?z/y:z,U=Ut*u,st=Math.round(x*(h||0)*100)/100,$t=Math.round(st*u),ut=Math.round(x*(m||0)*100)/100,it=Math.round(ut*u),at=Math.round(x*(P||0)*100)/100,Ct=Math.round(at*u),Ft=W+st+ut,M=x*(1-i);let A,k,R,j,O,X;if(F==="maestra"){const ct=1-i-n;k=n>0?Math.round(M/ct*100)/100:x,A=Math.round(k*n*100)/100,R=Math.round(k*ct*100)/100,X=W,j=Math.round((k-X-R)*100)/100,O=k>0?j/k:0}else F==="precio-lista-total"?(A=Math.round(b*n*100)/100,k=n>0?Math.round((x+A)*100)/100:x,j=A,O=n,X=W,R=Math.round((x-X-j)*100)/100):(A=Math.round(e*n*100)/100,k=n>0?Math.round((x+A)*100)/100:x,j=A,O=n,X=W,R=Math.round((x-X-j)*100)/100);const ee=R*u,Re=k*u,oe=Math.pow(1+(C||St.PLUSVALIA_DEFAULT),5)-1,Oe=f*(1+oe)*St.HAIRCUT_VENTA,Ve=Ft*u,Ne=v.map((ct,zt)=>{const Mt=(g||[0,0,0])[zt]||0,He=p*12,Rt=To(ct/12,He,ee),Ge=Rt/u,ne=Mt-Rt,qe=ne*St.MESES_ARRIENDO_ANIO*5,Je=k>0?Mt*St.MESES_ARRIENDO_ANIO/u/k:0,Ke=Mt*.9,se=f>0?Math.round(Ke*12/f*1e4)/1e4:0,We=Math.round(se*5*1e4)/1e4;return{cae:ct,arriendoMensualCLP:Mt,cuotaMensualCLP:Math.round(Rt),cuotaMensualUF:Math.round(Ge*100)/100,flujoMensualCLP:Math.round(ne),flujoAcumuladoCLP:Math.round(qe),capRate:Math.round(Je*1e4)/1e4,roi5Anios:We,roiAnual:se}});return{valorUF:u,precioListaDepto:e,precioListaOtros:l,precioListaTotal:b,precioDescDepto:Math.round(E*100)/100,precioDescOtros:S,valorVentaUF:Math.round(x*100)/100,valorVentaCLP:Math.round(f),piePct:i,upfrontPct:c||0,pieTotalDeptoUF:Math.round(B*100)/100,pieTotalConjuntosUF:Math.round(J*100)/100,pieTotalUF:Math.round(W*100)/100,reservaUF:Math.round(Bt*100)/100,upfrontUF:ot,saldoPieUF:Math.round(z*100)/100,saldoPieCLP:Math.round(pt),cuotasPieN:y,valorCuotaPieUF:Math.round(Ut*100)/100,valorCuotaPieCLP:Math.round(U),cuotonUF:st,cuotonCLP:$t,piePeriodoConstruccionUF:ut,piePeriodoConstruccionCLP:it,pieCreditoDirectoUF:at,pieCreditoDirectoCLP:Ct,totalPieInmobUF:Math.round(Ft*100)/100,descuentoAdicionalPct:0,bonoPieUF:A,saldoAporteInmobUF:Math.round(j*100)/100,aportePct:Math.round(O*1e4)/1e4,pieCreditoHipUF:Math.round(X*100)/100,tasacionUF:Math.round(k*100)/100,tasacionCLP:Math.round(Re),creditoHipBaseUF:Math.round(M*100)/100,creditoHipFinalUF:Math.round(R*100)/100,creditoHipFinalCLP:Math.round(ee),plusvaliaAcumulada:Math.round(oe*1e4)/1e4,precioVentaAnio5CLP:Math.round(Oe),piePagadoCLP:Math.round(Ve),escenarios:Ne}}let _=null,kt="";function Me(t,e){if(typeof t=="number"){Xo(t,e);return}try{const{project:o,depto:n,secundarios:s=[]}=t;console.log("[Cotizador] cotizFromProp",{project:o,depto:n,secundarios:s});const a=$.CC_DATA[o.id]||null,i=Mo(a,o.inmobiliaria),c=Do(o.inmobiliaria),p=i.reservaUF>0?Math.round(i.reservaUF*$.UF):i.reservaCLP;_={project:o,depto:n,secundarios:s,parsedCC:i,regla:c,reservaCLP:p,cliente:null},ko(),document.getElementById("cotiz-basic").style.display="none",document.getElementById("cotiz-client-form").style.display="flex",document.getElementById("cotiz-panel").style.display="none",window.openModule("cotiz")}catch(o){console.error("[Cotizador] Error en cotizFromProp:",o),document.getElementById("cotiz-basic").style.display="none",document.getElementById("cotiz-client-form").style.display="none",document.getElementById("cotiz-panel").style.display="flex",window.openModule("cotiz"),document.getElementById("cp-results").innerHTML=`<div style="background:#FEF2F2;border:1px solid #FCA5A5;border-radius:10px;padding:20px;color:#991B1B;font-family:monospace;font-size:13px;white-space:pre-wrap">${r(String(o))}

${r(o.stack||"")}</div>`}}function Se(){if(_)try{const t=No(),e=Ho(t),o=_o(e);console.log("[Cotizador] Input:",e),console.log("[Cotizador] Resultado:",o),Go(o,t)}catch(t){console.error("[Cotizador] Error en recalcCotizPanel:",t),document.getElementById("cp-results").innerHTML=`<div style="background:#FEF2F2;border:1px solid #FCA5A5;border-radius:10px;padding:20px;color:#991B1B;font-family:monospace;font-size:13px;white-space:pre-wrap">${r(String(t))}

${r(t.stack||"")}</div>`}}function Ao(){var e,o;const t=_?{pid:(e=_.project)==null?void 0:e.id,dp:(o=_.depto)==null?void 0:o.dp,extraDps:(_.secundarios??[]).map(n=>n.dp)}:null;_=null,document.getElementById("cotiz-client-form").style.display="none",document.getElementById("cotiz-panel").style.display="none",document.getElementById("cotiz-basic").style.display="",window.openModule("pri"),t!=null&&t.pid&&window.reopenWithUnit(t.pid,t.dp,t.extraDps)}function lt(t){return+((t??0)*100).toFixed(2)}function ko(){const{project:t,depto:e,secundarios:o}=_,n=[`${t.nombre} · DP ${e.dp}${e.tipologia?" "+e.tipologia:""}`,...o.map(c=>`${c.tipologia?c.tipologia+" ":""}DP ${c.dp}`)];document.getElementById("ccf-header-title").textContent=n.join(" + ");const s=e.precio_uf+o.reduce((c,p)=>c+p.precio_uf,0),a=[`DP ${e.dp}${e.tipologia?" — "+e.tipologia:""} · ${d.uf2(e.precio_uf)}`,...o.map(c=>`${c.tipologia?c.tipologia+" ":""}DP ${c.dp} · ${d.uf2(c.precio_uf)}`)];document.getElementById("ccf-prop-summary").innerHTML=`<div class="ccf-prop-lines">${a.map(c=>`<div class="ccf-prop-line">${r(c)}</div>`).join("")}</div><div class="ccf-prop-total">Total precio lista: <strong>${d.uf2(s)}</strong></div>`,["ccf-nombre","ccf-rut","ccf-email","ccf-tel"].forEach(c=>{const p=document.getElementById(c);p&&(p.value="",p.classList.remove("cp-input--err"))});const i=document.getElementById("ccf-objetivo");i&&(i.value="",i.classList.remove("cp-input--err")),document.querySelectorAll(".ccf-err").forEach(c=>{c.textContent=""});try{const c=JSON.parse(localStorage.getItem("_corredor")||"{}");c.nombre&&(document.getElementById("ccf-cor-nombre").value=c.nombre),c.email&&(document.getElementById("ccf-cor-email").value=c.email),c.tel&&(document.getElementById("ccf-cor-tel").value=c.tel)}catch{}}function jo(t){const e=t.replace(/[.\s]/g,"").toUpperCase();if(!/^\d{7,8}-?[0-9K]$/.test(e))return!1;const o=e.replace("-",""),n=o.slice(0,-1),s=o.slice(-1);let a=0,i=2;for(let v=n.length-1;v>=0;v--)a+=parseInt(n[v])*i,i=i===7?2:i+1;const c=11-a%11,p=c===11?"0":c===10?"K":String(c);return s===p}function ce(t){return/^[^\s@]+@[^\s@]+\.[^\s@]{2,}$/.test(t.trim())}function le(t){const e=t.replace(/[\s\-\(\)\.]/g,"");return/^(\+?56)?9\d{8}$/.test(e)||/^\+?56[2-9]\d{7}$/.test(e)}function H(t,e){const o=document.getElementById(t),n=document.getElementById(t+"-err");o&&o.classList.toggle("cp-input--err",!!e),n&&(n.textContent=e||"")}function zo(t){H(t,"")}function Ro(t){const e=document.getElementById(t);if(!e)return;const o=e.value.replace(/[^\dkK]/g,"").toUpperCase();if(o.length>1){const n=o.slice(0,-1),s=o.slice(-1);e.value=n.replace(/\B(?=(\d{3})+(?!\d))/g,".")+"-"+s}H(t,"")}function Oo(){if(!_)return;let t=!0;const e=u=>{var h;return(((h=document.getElementById(u))==null?void 0:h.value)||"").trim()},o=e("ccf-nombre");o.length<2&&(H("ccf-nombre","Ingresa el nombre completo"),t=!1);const n=e("ccf-rut");n?jo(n)||(H("ccf-rut","RUT inválido — verifica el dígito verificador"),t=!1):(H("ccf-rut","Ingresa el RUT"),t=!1);const s=e("ccf-email");s?ce(s)||(H("ccf-email","Formato de email inválido"),t=!1):(H("ccf-email","Ingresa el email"),t=!1);const a=e("ccf-tel");a?le(a)||(H("ccf-tel","Formato inválido — ej: +56 9 1234 5678"),t=!1):(H("ccf-tel","Ingresa el teléfono"),t=!1);const i=e("ccf-objetivo");i||(H("ccf-objetivo","Selecciona un objetivo"),t=!1);const c=e("ccf-cor-nombre");c.length<2&&(H("ccf-cor-nombre","Ingresa el nombre del corredor"),t=!1);const p=e("ccf-cor-email");p?ce(p)||(H("ccf-cor-email","Formato de email inválido"),t=!1):(H("ccf-cor-email","Ingresa el email del corredor"),t=!1);const v=e("ccf-cor-tel");if(v?le(v)||(H("ccf-cor-tel","Formato inválido — ej: +56 9 1234 5678"),t=!1):(H("ccf-cor-tel","Ingresa el teléfono del corredor"),t=!1),!!t){try{localStorage.setItem("_corredor",JSON.stringify({nombre:c,email:p,tel:v}))}catch{}_.cliente={nombre:o,rut:n,email:s,tel:a,objetivo:i,corNombre:c,corEmail:p,corTel:v},_.cotizId=Zo(),Vo(_.parsedCC),document.getElementById("cotiz-client-form").style.display="none",document.getElementById("cotiz-panel").style.display="flex",Se()}}function Vo(t){const e=Math.round((t.piePctDefault??Ue)*100),o=lt((t.descuentoDepto??0)+(t.descuentoAdicional??0)),n=lt(t.aporteInmobiliario),s=t.cuotasPieN??0,a=lt(t.pieConstPct),i=lt(t.cuotonPct),c=lt(t.upfrontPct),p=lt(t.creditoDirectoPct),[v,u,h]=So.map(g=>lt(g)),m=`Cuotas pie${s>0?` <span class="cp-fg-base">base ${s}</span>`:""}`,P=`Cuotón %${i===0?' <span class="cp-fg-noapl">no aplica</span>':""}`,y=(g,C,F,I,l,b)=>`<div class="cp-fg"><label class="cp-fg-lbl">${g}</label><input id="${C}" class="cp-input" type="number" min="${I}" max="${l}" step="${b}" value="${F}" onchange="recalcCotizPanel()"></div>`;document.getElementById("cp-params-grid").innerHTML=`
    ...
    <div class="cp-params-body">
      <div class="cp-form-row cp-form-row--4">
        ...
        ${y("Plazo (años)","cpg-plazo",Be,5,30,1)}
    ...
    </div>`}function No(){const t=e=>{var n;const o=parseFloat((n=document.getElementById(e))==null?void 0:n.value);return isNaN(o)?0:o};return{pie:t("cpg-pie")||Ue*100,plazo:t("cpg-plazo")||Be,dcto:t("cpg-dcto"),aporte:t("cpg-aporte"),cuotas:t("cpg-cuotas"),piecst:t("cpg-piecst"),cuoton:t("cpg-cuoton"),upfront:t("cpg-upfront"),cdir:t("cpg-cdir"),plusvalia:t("cpg-plusvalia")||2,cae1:t("cpg-cae1")||4,cae2:t("cpg-cae2")||4.5,cae3:t("cpg-cae3")||5}}function Ho(t){const{reservaCLP:e,regla:o,depto:n,secundarios:s}=_;return{precioListaDepto:n.precio_uf,descuentoPct:t.dcto/100,descuentoAdicionalPct:0,bonoPiePct:t.aporte/100,reservaCLP:e,preciosConjuntos:s.map(a=>a.precio_uf),piePct:t.pie/100,upfrontPct:t.upfront/100,cuotasPieN:t.cuotas,cuotonPct:t.cuoton/100,piePeriodoConstruccionPct:t.piecst/100,pieCreditoDirectoPct:t.cdir/100,plazoAnios:t.plazo,tasasCAE:[t.cae1/100,t.cae2/100,t.cae3/100],valorUF:$.UF,tipoCalculoBono:o.tipoCalculoBono,pieConjuntosPct:o.pieConjuntosPct,arriendosMensualesCLP:[0,0,0],plusvaliaAnual:t.plusvalia/100}}function N(t){return(Math.round(parseFloat(t)*1e3)/10).toFixed(1).replace(/\.0$/,"")+"%"}function Go(t,e){const{project:o,depto:n,secundarios:s}=_,a=[`${o.nombre} · DP ${n.dp}${n.tipologia?" "+n.tipologia:""}`,...s.map(i=>`${i.tipologia?i.tipologia+" ":""}DP ${i.dp}`)];document.getElementById("cp-header-title").textContent=a.join(" + "),document.getElementById("cp-results").innerHTML=qo(t,n,s)+Jo(t)+(t.pieCreditoDirectoUF>0?Ko(t):"")+Wo(t,e.plazo),Yo(t,e)}function qo(t,e,o){const n=t.precioListaDepto>0?1-t.precioDescDepto/t.precioListaDepto:0,s=`
    <tr>
  ...
  </div>`}function Ko(t){const e=t.valorVentaUF>0?t.pieCreditoDirectoUF/t.valorVentaUF:0;return`
  <div class="cp-section">
  ...
  </div>`}function Wo(t,e){const o=t.tasacionUF>0?t.creditoHipFinalUF/t.tasacionUF:0,n=t.escenarios.map((s,a)=>{const i=s.cuotaMensualCLP/.25;return`
  ...
  <div class="cp-section">
    ...
    </div>`}const I=t.tasacionUF>0?t.creditoHipFinalUF/t.tasacionUF:0,l=t.escenarios.map((b,D)=>{const E=b.cuotaMensualCLP/.25;return`<tr${D===1?' class="prd-esc-hl"':""}>
  ...
  <div class="prd-wrap">
  ...
  </div>`}const Dt=xt,en=["INGEVEC","RVC","TOCTOC","URMENETA","MAESTRA"];let bt=[],Nt=null,Q=1,Te="lista",yt=null,nt=null,rt=[],et=0;function De(t){return t?en.some(e=>t.toUpperCase().includes(e))?[1]:[]:[]}function on(){if(!$.PROJECTS.length){document.getElementById("pri-grid").innerHTML='<div class="empty-g"><div class="eg-ico">🏗️</div><p>No se pudo cargar los proyectos. Verificar backend.</p></div>';return}const t=[...new Set($.PROJECTS.map(e=>e.comuna).filter(Boolean))].sort();ue("pri",t),document.getElementById("pri-mc-input").addEventListener("blur",()=>window.mcClose("pri")),jt()}function jt(){var v,u,h,m,P,y;if(!$.PROJECTS.length)return;const t=(((v=document.getElementById("pri-search"))==null?void 0:v.value)||"").toLowerCase(),e=me("pri"),o=((u=document.getElementById("pri-entrega"))==null?void 0:u.value)||"",n=parseFloat((h=document.getElementById("pri-precio-min"))==null?void 0:h.value)||0,s=parseFloat((m=document.getElementById("pri-precio-max"))==null?void 0:m.value)||0,a=[...document.querySelectorAll('[data-grp="pri-dorm"].active')].map(g=>parseInt(g.dataset.val)),i=[...document.querySelectorAll('[data-grp="pri-bano"].active')].map(g=>parseInt(g.dataset.val)),c=((P=document.getElementById("pri-est"))==null?void 0:P.checked)||!1,p=((y=document.getElementById("pri-bod"))==null?void 0:y.checked)||!1;Nt=window._priMaxUF||null,bt=$.PROJECTS.filter(g=>{var I;let C=(g.unidades||[]).filter(l=>l.disponible&&!dt(l.tipologia));if(!C.length||t&&!`${g.nombre||""} ${g.inmobiliaria||""} ${g.comuna||""}`.toLowerCase().includes(t)||e.size&&!e.has(g.comuna)||o&&!((I=g.entrega)!=null&&I.toLowerCase().includes(o.toLowerCase()))||c&&!(g.unidades||[]).some(l=>l.disponible&&/estac|parking|reja/i.test(l.tipologia||""))||p&&!(g.unidades||[]).some(l=>l.disponible&&/bode/i.test(l.tipologia||""))||a.length&&(C=C.filter(l=>{const b=parseInt(l.dormitorios)||0;return a.some(D=>D===4?b>=4:b===D)}),!C.length)||i.length&&(C=C.filter(l=>{const b=parseInt(l.banos)||0;return i.some(D=>D===3?b>=3:b===D)}),!C.length))return!1;const F=Math.min(...C.map(l=>l.precio_uf).filter(l=>l>0));return!(n&&F<n||s&&F>s||Nt&&!C.some(l=>l.precio_uf<=Nt))}),Q=1,_e(),Te==="mapa"&&Fe(bt)}function nn(t){const e=Math.max(1,Math.ceil(bt.length/Dt));Q=Math.min(Math.max(1,Q+t),e),_e(),document.getElementById("pri-gondola-wrap").scrollTop=0}function _e(){const t=document.getElementById("pri-grid"),e=bt.length,o=Math.max(1,Math.ceil(e/Dt));Q>o&&(Q=o),document.getElementById("pri-count").textContent=`${e.toLocaleString("es-CL")} proyecto${e!==1?"s":""}`,document.getElementById("pri-pager").textContent=`Pág. ${Q} / ${o}`,document.getElementById("pri-prev").disabled=Q<=1,document.getElementById("pri-next").disabled=Q>=o;const n=document.getElementById("tb-stats");if(n&&(n.textContent=`${e.toLocaleString("es-CL")} proyectos · ${$.PROJECTS.length.toLocaleString("es-CL")} total`),!e){t.innerHTML='<div class="empty-g"><div class="eg-ico">🔍</div><p>Sin proyectos para los filtros seleccionados</p></div>';return}const s=bt.slice((Q-1)*Dt,Q*Dt);t.innerHTML=s.map(a=>{const i=(a.unidades||[]).filter(g=>g.disponible&&!dt(g.tipologia)),c=i.map(g=>g.precio_uf).filter(g=>g>0),p=c.length?Math.min(...c):0,v=c.length?Math.max(...c):0,u=a.foto_portada||"",h=[...new Set(i.map(g=>{const C=parseInt(g.dormitorios)||0;return C===0?"Estudio":C+"D"}))].sort().slice(0,3).join(", "),m=i.reduce((g,C)=>C.m2_interior&&C.m2_interior<g?C.m2_interior:g,9999),P=m<9999?m.toFixed(0)+" m²":"—",y=$.CC_DATA[a.id]||De(a.inmobiliaria).length;return`<div class="proj-card" onclick="openProject('${r(a.id)}')">
    ...
    <div class="pm-stat-card">
  ...
  </div>`;const g=[...new Set(o.map(f=>parseInt(f.piso)).filter(f=>f>0))].sort((f,T)=>f-T),C=[...new Set(o.map(f=>(f.orientacion||"").trim()).filter(Boolean))],F=o.map(f=>f.m2_terraza).filter(f=>f>0),I=[];if(g.length>0){const f=g.length===1?`Piso ${g[0]}`:`Pisos ${g[0]} – ${g[g.length-1]}`;I.push(`<div class="pm-detail-pill"><strong>${f}</strong></div>`)}if(C.length>0&&I.push(`<div class="pm-detail-pill">🧭 <strong>${C.slice(0,3).join(" · ")}</strong></div>`),F.length>0){const f=Math.min(...F).toFixed(0);I.push(`<div class="pm-detail-pill">🌿 Terraza desde <strong>${f} m²</strong></div>`)}I.length&&(y+=`<div class="pm-detail-row">${I.join("")}</div>`);const l=e.filter(f=>dt(f.tipologia)&&/estac|parking/i.test(f.tipologia||"")),b=e.filter(f=>dt(f.tipologia)&&/bode/i.test(f.tipologia||"")),D=l.filter(f=>f.disponible),E=b.filter(f=>f.disponible),S=[];if(l.length>0){const f=D.map(B=>B.precio_uf).filter(B=>B>0),T=f.length?Math.min(...f):0;S.push(`<div class="pm-extra-card">
    ...
    </div>`}document.getElementById("pm-proj-summary").innerHTML=y}function Ae(t){const e=document.getElementById("pm-cc-inner"),o=$.CC_DATA[t]||null;if(!o){e.innerHTML='<p class="pm-cc-empty">Sin condiciones comerciales disponibles para este proyecto.</p>';return}let n=`<div class="pm-cc-titulo">${r(o.titulo||"Condiciones Comerciales")}</div>`;if(o.campos&&o.campos.length){const s=o.campos.filter(([,i])=>i.length<=60),a=o.campos.filter(([,i])=>i.length>60);s.length&&(n+='<div class="pm-cc-section-lbl">Condiciones de venta</div>',n+='<div class="pm-cc-grid">',s.forEach(([i,c])=>{n+=`<div class="pm-cc-field"><span class="pm-cc-lbl">${r(i)}</span><span class="pm-cc-val">${r(c)}</span></div>`}),n+="</div>"),a.length&&(n+='<div class="pm-cc-section-lbl">Información adicional</div>',a.forEach(([i,c])=>{n+='<div style="margin-bottom:8px;background:#F7F8FC;border-radius:8px;padding:9px 12px">',n+=`<div class="pm-cc-lbl">${r(i)}</div>`,n+=`<div class="pm-cc-val-long">${r(c)}</div>`,n+="</div>"}))}o.tabla&&(n+=`<div class="pm-cc-section-lbl">${o.tabla.headers[0]==="Tipología"?"Tipologías":"Oportunidades"}</div>`,n+='<table class="pm-cc-tbl"><thead><tr>',o.tabla.headers.forEach(s=>{n+=`<th>${r(s)}</th>`}),n+="</tr></thead><tbody>",o.tabla.rows.forEach(s=>{n+="<tr>",s.forEach(a=>{n+=`<td>${r(a||"—")}</td>`}),n+="</tr>"}),n+="</tbody></table>"),o.nota&&(n+=`<div style="margin-top:14px;background:#EEF2FF;border-left:3px solid #3D3EA8;padding:9px 12px;border-radius:0 8px 8px 0;font-size:11.5px;color:#3D3EA8;line-height:1.5">${r(o.nota)}</div>`),e.innerHTML=n}function ke(t){const e=$.PROJECTS.find(m=>m.id===t);if(!e)return;yt=e,nt=null,document.getElementById("pm-title").textContent=e.nombre,document.getElementById("pm-sub").textContent=[e.inmobiliaria,e.comuna,e.entrega?"Entrega "+e.entrega:""].filter(Boolean).join(" · "),Yt("gal"),an(e),rt=e.fotos||[],et=0;const o=document.getElementById("pm-gal-img"),n=document.getElementById("pm-gal-spin"),s=document.getElementById("pm-gal-nophoto"),a=document.getElementById("pm-gal-thumbs"),i=document.getElementById("pm-gal-counter");n.style.display="none",rt.length?(s.style.display="none",Qt(0),a.innerHTML=rt.map((m,P)=>`<img src="${m}" onclick="pmShowGalPhoto(${P})" ${P===0?'class="active"':""}>`).join("")):(o.style.display="none",s.style.display="flex",a.innerHTML="",i.style.display="none",document.getElementById("pm-gal-prev").disabled=!0,document.getElementById("pm-gal-next").disabled=!0);const c=e.pdfs||[];document.getElementById("pm-pdf-list").innerHTML=c.length?c.map(m=>`<a class="pm-pdf-item" href="${m.path}" target="_blank" rel="noopener">
      ...
      </a>`).join(""):"";const p=document.getElementById("pm-tab-cc"),v=$.CC_DATA[e.id],u=De(e.inmobiliaria).length>0;v||u?(p.style.display="",Ae(e.id)):p.style.display="none";const h=(e.unidades||[]).filter(m=>m.disponible&&!dt(m.tipologia));document.getElementById("pm-units-body").innerHTML=h.map(m=>`
    <tr>
      <td>${r(m.dp)}</td>
      <td>${r(m.tipologia)}</td>
      <td>${r(m.piso||"—")}</td>
    ...
    </tr>`).join("")||'<tr><td colspan="8" style="text-align:center;padding:20px;color:var(--g400)">Sin unidades disponibles</td></tr>',document.getElementById("pm-step1").style.display="",document.getElementById("pm-step2").classList.remove("visible"),document.getElementById("proj-modal").classList.add("open"),document.body.style.overflow="hidden"}function Qt(t){var n;et=Math.max(0,Math.min(t,rt.length-1));const e=document.getElementById("pm-gal-img");e.src=rt[et],e.style.display="block";const o=document.getElementById("pm-gal-counter");o.style.display="block",o.textContent=`${et+1} / ${rt.length}`,document.getElementById("pm-gal-prev").disabled=et===0,document.getElementById("pm-gal-next").disabled=et===rt.length-1,document.querySelectorAll("#pm-gal-thumbs img").forEach((s,a)=>s.classList.toggle("active",a===et)),(n=document.getElementById("pm-gal-thumbs").children[et])==null||n.scrollIntoView({inline:"nearest",block:"nearest"})}function cn(t){Qt(et+t)}function Xt(){document.getElementById("proj-modal").classList.remove("open"),document.body.style.overflow="",yt=null,nt=null}function je(t){const e=yt,o=(e.unidades||[]).find(i=>i.dp===t);if(!o)return;nt=o,document.getElementById("pm-sel-title").textContent=`DP ${o.dp} · ${o.tipologia}${o.piso?" · Piso "+o.piso:""}`,document.getElementById("pm-sel-detail").textContent=[o.m2_interior?o.m2_interior.toFixed(1)+" m² útil":"",o.m2_terraza?o.m2_terraza.toFixed(1)+" m² terraza":"",o.orientacion||""].filter(Boolean).join(" · ");const n=(e.unidades||[]).filter(i=>i.disponible&&dt(i.tipologia)),s=document.getElementById("pm-extras-wrap"),a=document.getElementById("pm-extras-list");n.length?(s.style.display="",a.innerHTML=n.map(i=>`
      ...
      </label>`).join("")):(s.style.display="none",a.innerHTML=""),te(),document.getElementById("pm-step1").style.display="none",document.getElementById("pm-step2").classList.add("visible")}function te(){if(!nt)return;let t=nt.precio_uf||0;document.querySelectorAll("#pm-extras-list input[type=checkbox]:checked").forEach(e=>{t+=parseFloat(e.value)||0}),document.getElementById("pm-total-val").textContent=d.uf(t)}function ln(){document.getElementById("pm-step1").style.display="",document.getElementById("pm-step2").classList.remove("visible"),nt=null}function rn(){if(!nt||!yt)return;const t=yt,e=nt,o=[];document.querySelectorAll("#pm-extras-list input[type=checkbox]:checked").forEach(n=>{const s=(t.unidades||[]).find(a=>a.dp===n.dataset.dp);s&&o.push(s)}),Xt(),Me({project:t,depto:e,secundarios:o})}function dn(t){t.classList.toggle("active"),jt()}function pn(t,e,o=[]){ke(t),Yt("units"),e&&(je(e),o.length&&(o.forEach(n=>{const s=document.querySelector(`#pm-extras-list input[data-dp="${n}"]`);s&&(s.checked=!0)}),te()))}let It=null;function un(){const t=parseFloat(document.getElementById("p-renta").value)||0,e=parseFloat(document.getElementById("p-ahorro").value)||0,o=parseFloat(document.getElementById("p-deudas").value)||0,n=parseFloat(document.getElementById("p-plazo").value)||25,s=parseFloat(document.getElementById("p-tasa").value)||5,a=document.getElementById("p-results");if(document.getElementById("p-btns").style.display="none",!t){a.innerHTML='<div class="empty-tool"><div class="ei">👤</div><p>Ingresa la renta líquida del cliente</p></div>';return}const i=s/100/12,c=n*12,p=t*.25-o;if(p<=0){a.innerHTML='<div class="warn-card">⚠️ Las deudas mensuales superan la capacidad de pago del 25% de la renta.</div>';return}const v=(Math.pow(1+i,c)-1)/(i*Math.pow(1+i,c)),u=p*v/$.UF,h=e/$.UF,m=Math.min(u/.8,u+h),P=m*.2,y=Math.max(0,P-h);It=m;const g=[15,20,25,30];a.innerHTML=`<div class="perfil-card">
    <div class="rc-hero">
    ...
    <table class="rctbl">
      ...
      <tbody>${g.map(C=>{const F=C*12,I=(Math.pow(1+i,F)-1)/(i*Math.pow(1+i,F)),l=p*I/$.UF,b=Math.min(l/.8,l+h);return`<tr class="${C==n?"tr-hl":""}"><td>${C} años</td><td>${d.pesos(p)}</td><td>${d.uf(l)}</td><td><strong>${d.uf(b)}</strong></td></tr>`}).join("")}</tbody>
    </table>
  </div>`,document.getElementById("p-btns").style.display="flex"}function mn(t){It&&(t==="sec"?(window._secMaxUF=It,window.secFilter(),window.openModule("sec"),qt("sec")):(window._priMaxUF=It,window.priFilter(),window.openModule("pri"),qt("pri")))}function qt(t){var n;(n=document.getElementById("bb-"+t))==null||n.remove();const e=document.createElement("div");e.id="bb-"+t,e.className="filter-strip",e.style.cssText="background:#FFFBEB;border-bottom:1px solid #FCD34D;",e.innerHTML=`<span style="font-size:13px;color:#92400E">👤 Filtrando por presupuesto: <strong>${d.uf(It)}</strong></span>
    <button class="btn-clear-budget" onclick="clearBudget('${t}')">✕ Limpiar filtro</button>`;const o=document.getElementById("mod-"+t);o.insertBefore(e,o.querySelector(".filter-strip"))}function gn(t){var e;t==="sec"?(window._secMaxUF=null,window.secFilter()):(window._priMaxUF=null,window.priFilter()),(e=document.getElementById("bb-"+t))==null||e.remove()}const vn={sec:"Stock Secundario",pri:"Proyectos Nuevos",perfil:"Perfilador",cotiz:"Cotizador"};Object.assign(window,{openModule:ze,mcFilter:ge,mcOpen:Ze,mcClose:Ye,mcSelect:Qe,mcRemove:Xe,secFilter:Tt,secPage:yo,setSecView:$o,openDetail:Ie,openSecDetail:Co,showDpPhoto:Kt,navDp:Gt,closeDetail:Wt,shareProperty:Eo,downloadPhotos:xo,printFicha:wo,openVideo:Io,copyVideoLink:Lo,closeVideo:Le,toggleSecPill:t=>{t.classList.toggle("active"),Tt()},togglePriPill:t=>{t.classList.toggle("active"),jt()},toggleTipPill:t=>{t.classList.toggle("active"),Tt()},toggleDormPill:dn,priFilter:jt,priPage:nn,setPriView:sn,openProject:ke,closeProjModal:Xt,pmTab:Yt,renderCC:Ae,pmShowGalPhoto:Qt,pmGalNav:cn,selectProjUnit:je,pmUpdateTotal:te,pmBack:ln,pmCotizar:rn,reopenWithUnit:pn,calcPerfil:un,searchFromPerfil:mn,showBudgetBanner:qt,clearBudget:gn,cotizFromProp:Me,syncPie:tn,calcCotiz:Zt,recalcCotizPanel:Se,volverDesdeCotiz:Ao,submitClientForm:Oo,formatRutInput:Ro,clearCCFError:zo,printCotiz:Qo});function ze(t){document.querySelectorAll(".module").forEach(n=>n.classList.remove("active")),document.querySelectorAll(".snav-btn").forEach(n=>n.classList.remove("active")),document.getElementById("mod-"+t).classList.add("active"),document.querySelector(`.snav-btn[data-m="${t}"]`).classList.add("active"),document.getElementById("topbar-title").textContent=vn[t]||t;const e=document.getElementById("sbf-sec"),o=document.getElementById("sbf-pri");e&&(e.style.display=t==="sec"?"":"none"),o&&(o.style.display=t==="pri"?"":"none")}document.addEventListener("keydown",t=>{if(document.getElementById("detail-modal").classList.contains("open")){t.key==="Escape"&&Wt(),t.key==="ArrowLeft"&&Gt(-1),t.key==="ArrowRight"&&Gt(1);return}t.key==="Escape"&&Le()});document.getElementById("detail-modal").addEventListener("click",t=>{t.target===t.currentTarget&&Wt()});document.getElementById("proj-modal").addEventListener("click",t=>{t.target===t.currentTarget&&Xt()});async function fn(){try{const[t,e,o,n,s,a]=await Promise.all([gt.uf(),gt.stock(),gt.projects(),gt.cc(),gt.geocodes(),gt.priGeo()]);$.UF=t.valor??$.UF,$.STOCK=e??[],$.PROJECTS=o??[],$.CC_DATA=n??{};const i=document.getElementById("uf-val"),c=document.getElementById("uf-date");if(i&&(i.textContent=$.UF.toLocaleString("es-CL",{minimumFractionDigits:2,maximumFractionDigits:2})),c&&t.fecha){const p=new Date(t.fecha);c.textContent=p.toLocaleDateString("es-CL",{day:"numeric",month:"short"})}s&&Object.assign($._GC,s),a&&Object.assign($._GC,a);try{const p=JSON.parse(localStorage.getItem("_geo_cache")||"{}");Object.assign($._GC,p)}catch{}}catch(t){console.error("Bootstrap data load failed:",t)}ho(),on(),ze("sec")}fn();
