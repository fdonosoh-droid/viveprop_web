"""
MobySuite - Descarga consolidada de stock URMENETA
...
# ─── CONFIGURACIÓN ────────────────────────────────────────────────────────────
BEARER_TOKEN  = "555cf4dd3c7468084c07b051a9359d234e41fa91"
CAPTCHA_TOKEN = ("eyJhbGdvcml0aG0iOiJTSEEtMjU2IiwiY2hhbGxlbmdlIjoiNjUzMzhlM2FkMWRkYjFjMjY0M2Q1MWMwNzg2"
                 "MWZkMzZhNTRlNTc2YzRjNGU2ODliNzU0Yjc1NWQ5OTA2MmZjYiIsIm51bWJlciI6MTYyMDUsInNhbHQiOiJkNTk0"
                 "NGQ1ZjYxY2EyZjYzYzZkY2M3ZWYiLCJzaWduYXR1cmUiOiJhNWRmZGJmNTU1NGFlYThmOWRjMWU4NWIwOGYwNDIy"
                 "MTlmZWE5MTA2Y2I4NGEwNTJjZDIzYmRmYmUwZTM1ZGVkIiwidG9vayI6Nzh9")

BASE_URL   = "https://urmenetagi-api.mobysuite.com/v1/api"
COMPANY_ID = 1
...
HEADERS = {
    ...
    "origin": "https://urmenetagi.mobysuite.com",
    "referer": "https://urmenetagi.mobysuite.com/",
...
def build_excel(projects, all_assets_by_project, output_path):
    ...
    for project in projects:
        pid = project["id"]
        for asset in all_assets_by_project.get(pid, []):
...
def main():
    print("=" * 55)
    print("  MobySuite - Descarga de Stock URMENETA")
    print("=" * 55)
    ...
    output_path = f"{OUTPUT_DIR}/urmeneta_stock_{ts}.xlsx"
